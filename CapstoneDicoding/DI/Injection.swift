...
final class Injection: NSObject {
    ...
    func provideFavorite<U: FavoriteUseCase>() -> U where U.Request == String, U.Response == MovieObject {
        ...
        let local = GetFavoriteMoviesDataSource(realm: realm!)
        
        let repository = GetFavoriteMovieRepository(localeDataSource: local)
    ...
    func provideFavorites<U: UseCase>() -> U where U.Request == String, U.Response == [Movie] {
        ...
        let repository = GetFavoriteMoviesRepository(localeDataSource: local)
